...
export default function Aquariums({ aquarium, currentPage, totalPages }) {
  const path = "akwarystyka";

  return (
    <Layout>
      <h1 className="text-3xl self-start mt-[50px] container">
        Akwarystyka - artykuły
      </h1>
