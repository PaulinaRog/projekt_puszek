...
export const getStaticProps = () => {
  ...
  categories.forEach((category) => {
    ...
    data[category.name] = lastThreeArticles;
  });
  ...
  return (
    <Layout>
      <div className="my-[50px] container">
        <h1 className="text-3xl self-start">Ostatnie artykuły</h1>
      ...
      <div className="h-fit my-[50px] flex flex-col gap-5 container items-center">
        {categories.map((category) => (
          <div
            className="flex flex-col lg:w-[50vw] w-[90vw] mb-10 border-[1px] rounded-2xl shadow-lg dark:shadow-shdw-dark  shadow-shdw-light border-secondary-light bg-secondary-light dark:bg-bg-dark dark:border-acc-dark"
            key={category.name}
          >
